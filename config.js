...
const APP_CONFIG = {
  ...
  // --------------------------------------------------------------------------
  SUPABASE: {
    URL: "https://weouzbtdjclflupumwpt.supabase.co",
    PUBLISHABLE_KEY: "sb_publishable_sm3CVKcNFksv7dxaUsp7DQ_EDhjg8Pq",
    STORAGE_BUCKET: "issue-images"
  },

  // EmailJS sends a municipality notification after a report is saved.
  // Add only EmailJS public values here; never add an email password or private key.
  EMAILJS: {
    ENABLED: true,
    SERVICE_ID: "service_8998",
    TEMPLATE_ID: "template_ggfohnb",
    PUBLIC_KEY: "Zj2fhPsKxSfdbul3q"
  },
